...
int main()
{
    ...
    const size_t basic_domain_size_special = (1ull<<libff::mnt6_Fr::s) - 1ul;
    const size_t step_domain_size_special = (1ull<<10) + (1ull<<8) - 1ul;
    const size_t extended_domain_size_special = (1ull<<(libff::mnt6_Fr::s+1)) - 1ul;
