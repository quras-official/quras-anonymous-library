...
int main()
{
    ...
    const size_t basic_domain_size = 1ull<<libff::mnt6_Fr::s;
    const size_t step_domain_size = (1ull<<10) + (1ull<<8);
    const size_t extended_domain_size = 1ull<<(libff::mnt6_Fr::s+1);
