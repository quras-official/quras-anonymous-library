...
void test_arithmetic_consistency_enforcer_gadget()
{
    ...
    instruction_results.allocate(pb, 1ull<<ap.opcode_width(), "instruction_results");
    instruction_flags.allocate(pb, 1ull<<ap.opcode_width(), "instruction_flags");
    ...
    for (size_t t = 0; t < 1ull<<ap.opcode_width(); ++t)
    {
