...
{
    assert_except(min_element <= max_element);
...
{
    assert_except(min_element <= position && position <= max_element);
...
{
    assert_except(min_element <= slice_min_element && slice_min_element <= slice_max_element && slice_max_element <= max_element);
