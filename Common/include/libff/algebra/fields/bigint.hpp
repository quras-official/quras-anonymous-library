/** @file
 *****************************************************************************
 Declaration of bigint wrapper class around GMP's MPZ long long integers.
 *****************************************************************************
...
/**
 * Wrapper class around GMP's MPZ long long integers. It supports arithmetic operations,
...
public:
    ...
    bigint() = default;
    bigint(const unsigned long long x); /// Initalize from a small integer
    ...
    unsigned long long as_ulong() const; /// Return the last limb of the integer
