...
public:
	...
	void generate_r1cs_constraints() {
		...
		assetID->generate_r1cs_constraints();
	}
	...
	void generate_r1cs_witness(const Note& note) {
		...
		assetID->bits.fill_with_bits(this->pb, uint256_to_bool_vector(note.assetID));
	}
};
