...
typedef libquras::NoteEncryption<QR_NOTEPLAINTEXT_SIZE> QRNoteEncryption;
typedef libquras::NoteDecryption<QR_NOTEPLAINTEXT_SIZE> QRNoteDecryption;

typedef libquras::PaymentDisclosureNoteDecryption<QR_NOTEPLAINTEXT_SIZE> QRPaymentDisclosureNoteDecryption;