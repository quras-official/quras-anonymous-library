...
namespace libquras {
	...
	class QRProof {
	public:
		libff::bn128_pp::G1_type g_A;
		libff::bn128_pp::G1_type g_A_prime;
		libff::bn128_pp::G2_type g_B;
		libff::bn128_pp::G1_type g_B_prime;
		libff::bn128_pp::G1_type g_C;
		libff::bn128_pp::G1_type g_C_prime;
		libff::bn128_pp::G1_type g_K;
		libff::bn128_pp::G1_type g_H;

	public:
		QRProof() : g_A(), g_A_prime(), g_B(), g_B_prime(), g_C(), g_C_prime(), g_K(), g_H() { }

		int Size();
		// Produces a compressed proof using a libsnark zkSNARK proof
		template<typename libsnark_proof>
		QRProof(const libsnark_proof& proof);
		...
		friend bool operator==(const QRProof& a, const QRProof& b)
		{
			return (
				a.g_A == b.g_A &&
