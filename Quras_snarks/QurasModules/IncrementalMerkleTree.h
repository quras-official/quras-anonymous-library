#pragma once
#ifndef QR_INCREMENTALMERKLETREE_H_
#define QR_INCREMENTALMERKLETREE_H_
...
typedef libquras::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libquras::SHA256Compress> QRIncrementalMerkleTree;
typedef libquras::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libquras::SHA256Compress> QRTestingIncrementalMerkleTree;

typedef libquras::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libquras::SHA256Compress> QRIncrementalWitness;
typedef libquras::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libquras::SHA256Compress> QRTestingIncrementalWitness;

#endif /* QR_INCREMENTALMERKLETREE_H_ */
