...
namespace libquras {
	...
	template class NoteEncryption<QR_NOTEPLAINTEXT_SIZE>;
	template class NoteDecryption<QR_NOTEPLAINTEXT_SIZE>;

	template class PaymentDisclosureNoteDecryption<QR_NOTEPLAINTEXT_SIZE>;
